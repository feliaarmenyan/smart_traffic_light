...
void modifyPathsImages2Annotations(char *path, char *labelpath)
{
...
{
    char labelpath[4096];
    modifyPathsImages2Annotations(path, labelpath);
...
matrix load_regression_labels_paths(char **paths, int n, int k)
{
    ...
    for(i = 0; i < n; ++i){
        char labelpath[4096];
		modifyPathsImages2Annotations(paths[i], labelpath);
